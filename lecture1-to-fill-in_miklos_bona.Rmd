...
# -> Error in library(ggplot) : there is no package called ‘ggplot’ (I have tried loading ggplot instead of ggplot2 - I figured there has to be an earlier version than 2...)
